...
const InformasiForm = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-backgroundImg bg-no-repeat bg-cover w-full p-4">
            <div className="container transition duration-500 mx-auto p-4 mb-4 bg-blue rounded-lg shadow-md lg:w-1/2 sm:w-2/3 w-full mt-16 relative" data-aos="fade-up">
