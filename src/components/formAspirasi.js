export default function FormAspirasi({ isExpanded, toggleExpand }) {
    return (
        <div className={`container mx-auto p-4 transition duration-500 bg-mediumGreen rounded-lg shadow-md w-full ${!isExpanded ? 'hover:bg-darkGreen' : ''}`}>
            <div className="flex justify-between items-center cursor-pointer" onClick={toggleExpand}>
                <h1 className="text-2xl text-white font-bold">Aspirasi</h1>
                <svg
