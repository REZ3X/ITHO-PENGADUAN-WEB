...
const MostWatch = () => {
    ...
    return (
        <div className="h-auto mt-8 flex flex-col items-center justify-center backdrop-blur-2xl p-4 w-[1050px]">
            ...
            <div className="grid text-white grid-cols-1 md:grid-cols-3 gap-8">
                {tutorials.map((tutorial) => (
                    <div key={tutorial.id} className="bg-[#5a6b58] pb-6 p-4 rounded-lg shadow-md mt-[-15px]">
